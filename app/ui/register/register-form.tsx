  ...
  return (
    <form id="register" className="flex w-full flex-col">
      <div className="flex-1 rounded-lg border border-gray-200 bg-gray-50 px-6 pb-4 pt-8">
        ...
        <button
          className="flex mt-4 w-full h-10 items-center rounded-lg bg-gray-600 px-4 py-2 text-sm text-white transition-colors hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black-500 active:bg-black-600 aria-disabled:cursor-not-allowed aria-disabled:opacity-50"
          onClick={async (event) => {
